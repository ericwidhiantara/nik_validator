        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buttonParse(),
              SizedBox(height: 20),
              nikResult != null ? _resultWidget() : SizedBox(),
            ],
          ),
        ),
      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(color: Colors.black),
            _textWidgeT(title: "Provinsi ID", value: nikResult!.provinceId!),
            Divider(color: Colors.black),
            _textWidgeT(title: "Kota/Kabupaten", value: nikResult!.city!),
            Divider(color: Colors.black),
            _textWidgeT(title: "Kota/Kabupaten ID", value: nikResult!.cityId!),
            Divider(color: Colors.black),
            _textWidgeT(title: "Kecamatan", value: nikResult!.subdistrict!),
            Divider(color: Colors.black),
            _textWidgeT(
                title: "Kecamatan Id", value: nikResult!.subdistrictId!),
            Divider(color: Colors.black),
